...
class MyGrid(GridLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.cols=1
        self.btn=Button(background_normal = '3.png', background_down ='3.png')
        ...
        self.btn1=Button(text ="click here", color =(0, 0, 0, 1), background_normal = '1.png', background_down ='2.png', size_hint = (.1, .1), pos_hint = {"x":0.35, "y":0.3} )
        self.btn1.bind(on_press = self.pressed1)
        self.btn4=Button(text="Graph 1",color =(0, 0, 0, 1),background_normal = '8.1.jpg')
        ...
        self.btn2=Button(text="click here",color =(0, 0, 0, 1),background_normal = '4.jpg', background_down ='5.jpg')
        self.btn2.bind(on_press = self.pressed2)
        self.btn5=Button(text="Graph 2",color =(0, 0, 0, 1),background_normal = '8.1.jpg')
        ...
        self.btn3=Button(text="click here",color =(0, 0, 0, 1),background_normal = '6.jpg', background_down ='7.jpg')
        self.btn3.bind(on_press=self.pressed3)
        self.btn6=Button(text="Graph 3",color =(0, 0, 0, 1),background_normal = '8.1.jpg')
    ...
    def pressed2(self,instance):
        xlsx_file = Path("D:/study material/hardcoded/trackit","data6.xlsx")
        ...
        for i in range(0,5):
            popupLabel=Label(text=list1[i])
            layout.add_widget(popupLabel)
        popup=Popup(title="Top 5 dangerous states are:",content=layout,size_hint=(None,None),size=(600,300),background='9.jpg')
        popup.open()


    def pressed3(self,instance):
        xlsx_file = Path("D:/study material/hardcoded/trackit","data8.1.xlsx")
        wb_obj = openpyxl.load_workbook(xlsx_file)
        sheet = wb_obj.active


        xlsx_file1 = Path("D:/study material/hardcoded/trackit","data8.2.xlsx")
        wb_obj1 = openpyxl.load_workbook(xlsx_file1)
        sheet1 = wb_obj1.active


        xlsx_file2 = Path("D:/study material/hardcoded/trackit","data8.3.xlsx")
        ...
        for i in range(0,13):
            ...
            layout.add_widget(popupLabel)
        popup=Popup(title="Average cases per week :",content=layout,size_hint=(None,None),size=(600,300),background='9.jpg')
        popup.open()    
    ...
    def pressed6(self,instance):
        df = pd.read_excel(r"data7.1.xlsx",sheet_name=0)
        loc = ("D:/study material/hardcoded/trackit/data7.1.xlsx") 
